    ...
    <MainLayoutDashboard>
        <div class="p-3 sm:p-4 md:p-6">
            ...
            <div class="mb-4 sm:mb-6">
                <h1 class="text-xl sm:text-2xl font-bold text-gray-900 mb-1" :style="{color:colorText}"> Disponibilidad de Aulas </h1>
            ...
            <div v-else class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-3 sm:px-4 md:px-6 py-2 sm:py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">
                                    Acciones
                                </th>
                            </tr>
                        </thead>
                            ...
                            <tr v-for="aula in aulasPaginadas" :key="aula.id" class="hover:bg-gray-50 transition-colors">
                                <td class="px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-2 sm:gap-3">
                                        <div class="flex-shrink-0 h-8 w-8 sm:h-10 sm:w-10 rounded-lg flex items-center justify-center text-xs sm:text-base"
                                            :class="aula.disponible ? 'bg-blue-100' : 'bg-red-100'">
                                            <i class="fa-solid fa-hotel"></i>
                                        </div>
                                        <div class="min-w-0">
                                            <div class="text-xs sm:text-sm font-medium text-gray-900 truncate">{{ aula.nombre }}</div>
                ...
                <div v-if="aulasFiltradas.length > 0" class="bg-white px-3 sm:px-4 md:px-6 py-3 flex flex-col sm:flex-row items-center justify-between border-t border-gray-200 gap-3">

        ...
        <div class="p-6" v-if="isAuthenticated">
            <div>
                ...
                <div class="mb-8">
                    ...
                    <p class="text-slate-600">Selecciona los informes que deseas visualizar y descargar</p>
                </div>

                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 bg-white" :style="{padding: '12px', borderRadius:'8px'}">
                    <!--Panel de selección del reporte o informe-->
                    <div class="lg:col-span-1">
                        <div class="bg-white rounded-xl shadow-lg p-6">
                            <div class="flex items-center justify-between mb-4">
                                <h2 class="text-xl font-semibold text-slate-800">Informes Disponibles</h2>
                                <button
                            ...
                            <div class="space-y-2 max-h-96 overflow-y-auto">
                                ...
                                >
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1" @click="handleToggleReport(report.id)" >
                                            <h3 class="font-medium text-slate-800">{{ report.name }}</h3>
                                            <p class="text-sm text-slate-500">{{ report.category }}</p>
                            ...
                            <!-- Botones de Descarga -->
                            <div v-if="selectedReports.length > 0" class="mt-6 pt-6 border-t border-slate-200">
                                ...
                                <div class="space-y-2">
                                    <button
                                        ...
                                        class="w-full flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white py-2 px-4 rounded-lg transition-colors"
                                    >
                                    ...
                                    <button
                                        ...
                                        class="w-full flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded-lg transition-colors"
                                    >
                                        <i class="fa-solid fa-download"></i>
                                        Descargar Excel
                                    </button>
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white rounded-xl shadow-lg p-6">
                            ...
                            <div class="flex flex-col items-center justify-center py-16 text-center">
                                <i class="fa-regular fa-file" :style="{fontSize: '70px'}"></i>
...
<script setup>
    ...
    const availableReports = ref([
        { id: 1, name: 'Informe de Aulas', category: 'Aulas'},
        { id: 2, name: 'Informe de Docentes', category: 'Usuarios'},
